...
#include "ig_active_reconstruction_ros/robot_movement_cost_conversions.hpp"
...
namespace robot
{
  ig_active_reconstruction_msgs::MovementCostMsg movementCostToMsg(const MovementCost& cost)
  {
  ...
  MovementCost movementCostFromMsg( ig_active_reconstruction_msgs::MovementCostMsg& _msg )
  {
    MovementCost cost;
    cost.cost = _msg.cost;
